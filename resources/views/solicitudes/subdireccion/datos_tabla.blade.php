...
@section('title', 'subdirección: Solicitudes')
                ...
                <tbody>
                    @foreach ($solicitudes as $solicitud)
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('sub:resumen', $solicitud->id)}}" class="btn btn-outline-success btn-sm">Ver Solicitud     
                            </a><br></td>
                            <td><a href="{{route('sub:elimina', $solicitud->id)}}" class="btn btn-outline-danger btn-sm">Cancelar Solicitud
                            </button></td>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="{{route('sub:califica')}}"  class="btn btn-success">Confirmar</a>
        </div>
