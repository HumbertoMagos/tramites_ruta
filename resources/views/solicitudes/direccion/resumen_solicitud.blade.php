...
<div class="card">
    <div class="card-body">
        ...
        <a href="{{route('direccion:datos')}}" class="btn btn-outline-danger btn-block">Rechazar <i class="far fa-times-circle"></i></a>
    </div>
    <!-- The Modal -->
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="{{route('direccion:finaliza')}}"  class="btn btn-success">Confirmar</a>
        </div>
